...
module Types (T : Ctypes.TYPE) = struct
 ...
 let cuda_error_shared_object_symbol_not_found = T.constant "CUDA_ERROR_SHARED_OBJECT_SYMBOL_NOT_FOUND" T.int64_t
 ...
 let cuda_error_launch_incompatible_texturing = T.constant "CUDA_ERROR_LAUNCH_INCOMPATIBLE_TEXTURING" T.int64_t
 ...
 let cuda_error_host_memory_already_registered = T.constant "CUDA_ERROR_HOST_MEMORY_ALREADY_REGISTERED" T.int64_t
 ...
 let cuda_error_compat_not_supported_on_device = T.constant "CUDA_ERROR_COMPAT_NOT_SUPPORTED_ON_DEVICE" T.int64_t
