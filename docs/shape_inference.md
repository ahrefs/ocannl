...
* **Stage 7** sets all dim variables remaining in updated shapes to the lower bound if they have any, otherwise to dimension-1 (or dimension-0 if the variable is in `discardable_vars`).
