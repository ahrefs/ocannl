...
scalar_loss_sgd_update (i157 : [0..19], i158):
  ...
  /* b1 param sgd step */
  for i240 = 0 to 15 {
    n170[i240] := (0.000200 * b1[i240]);
  }
  for i242 = 0 to 15 {
    sgd_delta_b1[i242] := (b1.grad[i242] + n170[i242]);
  }
  n158[0] := i158;
  n162[0] := (40.000000 - n158[0]);
  n164[0] := (0.100000 * n162[0]);
  learning_rate[0] := (n164[0] / 20.000000);
  for i244 = 0 to 15 {
  ...
  for i257 = 0 to 15 {
    for i258 = 0 to 1 {
      n185[i257, i258] := (0.000200 * w1[i257, i258]);
    }
  }
  for i261 = 0 to 15 {
    for i262 = 0 to 1 {
  ...
  for i273 = 0 to 15 {
    for i274 = 0 to 15 {
      n190[i273, i274] := (0.000200 * w2[i273, i274]);
    }
  }
  for i277 = 0 to 15 {
    for i278 = 0 to 15 {
  ...
  /* w3 param sgd step */
  for i288 = 0 to 15 {
    n195[0, i288] := (0.000200 * w3[0, i288]);
  }
  for i290 = 0 to 15 {
