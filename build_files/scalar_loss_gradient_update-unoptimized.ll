...
scalar_loss_gradient_update (i157 : [0..19], i158):
  ...
  n141[0] := 1.000000;
  for i202 = 0 to 119 {
    n142[i202, 0] := (n141[0] - n139[i202, 0]);
  }
  for i204 = 0 to 119 {
  ...
  zero_out n144.grad;
  zero_out n147.grad;
  zero_out scalar_loss.grad;
  /* end */
  n156[0] := 1.000000;
  scalar_loss.grad[0] := n156[0];
  /* scalar_loss bprop */
  n147.grad[0] := (n147.grad[0] + (scalar_loss.grad[0] / n146[0]));
  n151[0] := 2.000000;
  n152[0] := powf(n146[0], n151[0]);
  n153[0] := -1.000000;
  n154[0] := (n153[0] * n147[0]);
  n155[0] := (n154[0] / n152[0]);
  for i208 = 0 to 119 {
    n144.grad[i208, 0] := (n144.grad[i208, 0] + n147.grad[0]);
  }
  for i209 = 0 to 119 {
