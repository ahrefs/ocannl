...
(** Queried CPU model, host partition and compiler target fingerprint. Unavailable probes disable
    persistent timing reuse; pool and codegen policy remain separately keyed by the limits. *)
