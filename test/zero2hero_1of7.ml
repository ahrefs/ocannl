  ...
  [%expect
    {|
                             ...
                             #31 grad_-                               │
                              1.000000000                             │
             #28 *.                   │       #21 *.                  │
              7.500000000e+1          │        2.000000000e+1         │
             #29 grad_*.              │       #22 grad_*.             │
              1.000000000             │        -1.000000000           │
    #27 3. Virt/40│ #24 **.           │#20 4. Virt/40│#17 x           │
    <void>        │  2.500000000e+1   │<void>        │ 5.000000000    │
                  │ #25 grad_**.      │              │#18 grad_x      │
                  │  3.000000000      │              │ 2.600000000e+1 │
                  │[17]│#23 2. Virt/40│              │                │
                  │    │<void>        │              │                │
    |}];
  ...
  [%expect
    {|
                           ...
                           #13 grad_*._l
                            1.000000000
                   #8 +_d                        │#10 f
                    4.000000000                  │ -2.400000095
                   #9 grad_+_d                   │#11 grad_f
                    -2.000000000                 │ 4.000000000
           #4 *._e              │#6 c            │
            -6.000000000        │ 1.019999981e+1 │
           #5 grad_*._e         │#7 grad_c       │
            -2.000000000        │ -2.000000000   │
    #0 a         │#2 b          │                │
     1.399999976 │ -2.599999905 │                │
    #1 grad_a    │#3 grad_b     │                │
     6.000000000 │ -4.000000000 │                │
    |}];
  ...
  [%expect
    {|
                         ...
                         #13 grad_*._l
                          1.000000000
                   #8 +_d                        │#10 f
                    6.559999943                  │ -2.400000095
                   #9 grad_+_d                   │#11 grad_f
                    -2.400000095                 │ 6.559999943
           #4 *._e              │#6 c            │
            -3.639999866        │ 1.019999981e+1 │
           #5 grad_*._e         │#7 grad_c       │
            -2.400000095        │ -2.400000095   │
    #0 a         │#2 b          │                │
     1.399999976 │ -2.599999905 │                │
    #1 grad_a    │#3 grad_b     │                │
     6.239999771 │ -3.360000134 │                │
    |}]
  ...
  [%expect
    {|
                              ...
                              #9 grad_+_v
                               1.000000000
                        #6 *                               │#0 b
                         -6.000000000                      │ 6.699999809
                        #7 grad_*                          │#1 grad_b
                         1.000000000                       │ 1.000000000
    #2 w                       │#4 x                       │
     -3.000000000  1.000000000 │ 2.000000000  0.000000000  │
    #3 grad_w                  │#5 grad_x                  │
     2.000000000  0.000000000  │ -3.000000000  1.000000000 │
    |}]
