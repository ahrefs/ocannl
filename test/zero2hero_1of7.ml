  ...
  [%expect
    {|
                             ...
                             #31 grad_-                             │
                              1.0000000                             │
              #28 *.                  │       #21 *.                │
               7.5000000e+1           │        2.0000000e+1         │
              #29 grad_*.             │       #22 grad_*.           │
               1.0000000              │        -1.0000000           │
    #27 3. Virt/40│  #24 **.          │#20 4. Virt/40│#17 x         │
    <void>        │   2.5000000e+1    │<void>        │ 5.0000000    │
                  │  #25 grad_**.     │              │#18 grad_x    │
                  │   3.0000000       │              │ 2.6000000e+1 │
                  │[17]│#23 2. Virt/40│              │              │
                  │    │<void>        │              │              │
    |}];
  ...
  [%expect
    {|
                     ...
                     #7 grad_*                     │#1 grad_b
                      1.0000000                    │ 1.0000000
    #2 w                   │#4 x                   │
     -3.0000000  1.0000000 │ 2.0000000  0.0000000  │
    #3 grad_w              │#5 grad_x              │
     2.0000000  0.0000000  │ -3.0000000  1.0000000 │
    |}]
