...
[@@expect.uncaught_exn {|
  ...
  Raised at Context.to_host in file "arrayjit/lib/context.ml", lines 350-353, characters 12-56
  Called from Context.get_value in file "arrayjit/lib/context.ml", line 382, characters 11-25
