...
[@@expect.uncaught_exn {|
  ...
  Raised at Context.to_host in file "arrayjit/lib/context.ml", lines 352-355, characters 12-56
  Called from Context.get_value in file "arrayjit/lib/context.ml", line 384, characters 11-25
