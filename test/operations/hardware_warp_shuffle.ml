...
let () =
  ...
  let side =
    Tn.create (Tn.Specified single) ~id:999005 ~label:[ "race_side" ]
      ...
      ()
  in
  Tn.update_memory_mode side Tn.Local (Site "992:test-setup");
  let with_side opt =
  ...
  let scratch =
    Tn.create (Tn.Specified single) ~id:999006 ~label:[ "race_scratch" ]
      ...
      ()
  in
  Tn.update_memory_mode scratch Tn.Local (Site "993:test-setup");
  ...
  let tile =
    Tn.create (Tn.Specified single) ~id:999007 ~label:[ "race_tile" ]
      ...
      ()
  in
  Tn.update_memory_mode tile Tn.Local (Site "994:test-setup");
