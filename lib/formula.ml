...
let binop ~op_label ?(compose_op=`Pointwise) ~op_body ~grad_body m1arg m2arg: t =
  ...
  let n1i_code = failwith "NOT IMPLEMENTED YET" in
  let n1i_call = failwith "NOT IMPLEMENTED YET" in
  let n2i_code = failwith "NOT IMPLEMENTED YET" in
  let n2i_call = failwith "NOT IMPLEMENTED YET" in
  let op_body = op_body ~nv ~n1v ~n1i_code ~n1i_call ~n2v ~n2i_code ~n2i_call in
  ...
  (* The code needs to be included in the reverse order to which it was computed! This guarantees
     ...
     non-tree DAGs. *)
  let grad_body = grad_body ~n1g ~n1i_code ~n1i_call ~n2g ~n2i_code ~n2i_call ~ng ~nv ~n1v ~n2v in
  let backprop_body =
...
let unop ~op_label ?init_shape ~transpose_op ~op_body ~grad_body m: t =
  ...
  let n1i_code = failwith "NOT IMPLEMENTED YET" in
  let n1i_call = failwith "NOT IMPLEMENTED YET" in
  let op_body = op_body ~nv ~n1v ~n1i_code ~n1i_call in
  ...
  let grad_body = grad_body ~n1g ~n1i_code ~n1i_call ~ng ~nv ~n1v in
