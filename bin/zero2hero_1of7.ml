...
(* export OCANNL_LOG_LEVEL_ZERO2HERO_1OF7=9 to enable debugging into the log_files/ directory. *)
[%%global_debug_log_level_from_env_var "OCANNL_LOG_LEVEL_ZERO2HERO_1OF7"]
